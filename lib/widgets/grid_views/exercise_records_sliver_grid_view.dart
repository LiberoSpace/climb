...
class ExerciseRecordsSliverGridView extends StatefulWidget {
  const ExerciseRecordsSliverGridView({
    super.key,
  });

  @override
  State<ExerciseRecordsSliverGridView> createState() =>
      _ExerciseRecordsSliverGridViewState();
}

class _ExerciseRecordsSliverGridViewState
    extends State<ExerciseRecordsSliverGridView> {
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      final newItems = await _exerciseRecordModel.getExerciseRecords(
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      slivers: [
        PagedSliverGrid<int, ExerciseRecordWithJoin>(
